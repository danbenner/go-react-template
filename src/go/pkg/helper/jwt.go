...
type JWTPayload struct {
	ClientID string `json:"client_id"` // *unique
...
// RetrieveToken - convert body to []byte, then unmarshal into map[string]interface{}
...
// ParseToken - split JWT into segments, then unmarshal header and payload
